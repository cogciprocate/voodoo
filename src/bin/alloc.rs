...
impl App {
    ...
    pub unsafe fn new() -> VooResult<App> {
        ...
        // let (test_buffers, test_buffer_memorys) = create_test_buffers(&device,
            // &command_pool)?;
...
fn create_test_buffers(device: &Device, command_pool: &CommandPool, bind: bool)
...
unsafe fn test_alloc() -> VooResult<()> {
    ...
    let (test_buffers, test_buffer_allocs) = create_test_buffers(&device,
        &command_pool, false)?;
