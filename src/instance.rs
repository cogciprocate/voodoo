...
impl Instance {
    ...
    pub fn get_physical_device_features<Pd>(&self, physical_device: Pd)
        ...
        unsafe {
            ...
            self.proc_addr_loader().core.vkGetPhysicalDeviceFeatures(physical_device.handle().0,
                &mut device_features);
            Ok(device_features.into())
        }
    }
    ...
    pub fn get_physical_device_format_properties<Pd>(&self, physical_device: Pd, format: Format)
        ...
        unsafe {
            ...
            self.proc_addr_loader().vkGetPhysicalDeviceFormatProperties(physical_device.handle().0,
    ...
    pub fn get_physical_device_properties<Pd>(&self, physical_device: Pd)
        ...
        unsafe {
            ...
            self.proc_addr_loader().vkGetPhysicalDeviceProperties(physical_device.handle().0,
                &mut device_properties);
            Ok(device_properties.into())
        }
    }
    ...
    pub fn get_physical_device_memory_properties<Pd>(&self, physical_device: Pd)
        ...
        unsafe {
            ...
            self.proc_addr_loader().core.vkGetPhysicalDeviceMemoryProperties(
                physical_device.handle().0, &mut mem_props);
        }
        Ok(mem_props.into())
    }
    ...
    pub fn enumerate_device_extension_properties<Pd>(&self, physical_device: Pd)
        ...
        unsafe {
            ::check(self.proc_addr_loader().core.vkEnumerateDeviceExtensionProperties(
                physical_device.handle().0, ptr::null(), &mut ext_count, ptr::null_mut()));
            assert!(ext_count as usize <= exts.inline_size());
            exts.set_len(ext_count as usize);
            ::check(self.proc_addr_loader().core.vkEnumerateDeviceExtensionProperties(
                physical_device.handle().0, ptr::null(), &mut ext_count,
    ...
    pub fn get_physical_device_surface_support_khr<Pd, Sk>(&self, physical_device: Pd,
        ...
        unsafe {
            ::check(self.proc_addr_loader().khr_surface.vkGetPhysicalDeviceSurfaceSupportKHR(
                physical_device.handle().0, queue_family_index, surface.handle().0, &mut supported));
        }
    ...
    pub fn get_physical_device_surface_capabilities_khr<Pd, Sk>(&self, physical_device: Pd,
        ...
        unsafe {
            ...
            self.proc_addr_loader().khr_surface.vkGetPhysicalDeviceSurfaceCapabilitiesKHR(
                physical_device.handle().0, surface.handle().0, &mut capabilities);
    ...
    pub fn get_physical_device_surface_formats_khr<Pd, Sk>(&self, physical_device: Pd,
        ...
        unsafe {
            self.proc_addr_loader().khr_surface.vkGetPhysicalDeviceSurfaceFormatsKHR(
                physical_device.handle().0, surface.handle().0, &mut format_count, ptr::null_mut());
            assert!(format_count as usize <= formats.inline_size());
            formats.set_len(format_count as usize);
            if format_count != 0 {
                self.proc_addr_loader().khr_surface.vkGetPhysicalDeviceSurfaceFormatsKHR(
                    physical_device.handle().0, surface.handle().0, &mut format_count,
    ...
    pub fn get_physical_device_surface_present_modes_khr<Pd, Sk>(&self, physical_device: Pd,
        ...
        unsafe {
            self.proc_addr_loader().khr_surface.vkGetPhysicalDeviceSurfacePresentModesKHR(
                physical_device.handle().0, surface.handle().0, &mut present_mode_count, ptr::null_mut());
            assert!(present_mode_count as usize <= present_modes.inline_size());
            present_modes.set_len(present_mode_count as usize);
            if present_mode_count != 0 {
                self.proc_addr_loader().khr_surface.vkGetPhysicalDeviceSurfacePresentModesKHR(
                    physical_device.handle().0, surface.handle().0, &mut present_mode_count, present_modes.as_mut_ptr() as *mut _);
            }
        }
