...
use ::{PRINT, VooResult, Loader, ApplicationInfo, PhysicalDeviceHandle, PhysicalDevice, CharStrs,
    ...
    DeviceHandle, ImageType, ImageTiling, ImageUsageFlags, ImageCreateFlags, ImageFormatProperties,
    SampleCountFlags, SparseImageFormatProperties, PresentModeKhr, DisplayPropertiesKhr,
    DisplayPlanePropertiesKhr, DisplayKhr, DisplayModePropertiesKhr, DisplayKhrHandle,
    DisplayModeCreateInfoKhr, DisplayPlaneCapabilitiesKhr, DisplayModeKhrHandle,
    DisplaySurfaceCreateInfoKhr, XlibSurfaceCreateInfoKhr, Display, XcbSurfaceCreateInfoKhr,
    xcb_connection_t, xcb_visualid_t, WaylandSurfaceCreateInfoKhr, wl_display, VisualID,
    MirSurfaceCreateInfoKhr, MirConnection, AndroidSurfaceCreateInfoKhr,
    PhysicalDeviceFeatures2Khr, PhysicalDeviceProperties2Khr, PhysicalDeviceExternalBufferInfoKhr,
    ExternalBufferPropertiesKhr, PhysicalDeviceExternalSemaphoreInfoKhr,
    ExternalSemaphorePropertiesKhr, PhysicalDeviceExternalFenceInfoKhr, ExternalFencePropertiesKhr,
...
impl Instance {
    ...
    pub fn get_physical_device_features<Pd>(&self, physical_device: Pd)
        ...
        unsafe {
            ...
            self.proc_addr_loader().core.vkGetPhysicalDeviceFeatures(physical_device.handle().to_raw(),
                &mut features);
            Ok(PhysicalDeviceFeatures::from_raw(features))
        }
    }
    ...
    pub fn enumerate_device_layer_properties<Pd>(&self, physical_device: Pd)
        ...
        unsafe {
            ::check(self.proc_addr_loader().core.vkEnumerateDeviceLayerProperties(
    ...
    pub unsafe fn get_physical_device_display_properties_khr<Pd>(&self, physical_device: Pd)
        ...
        self.proc_addr_loader().vkGetPhysicalDeviceDisplayPropertiesKHR(
            physical_device.handle().to_raw(), &mut property_count, ptr::null_mut());
        properties.reserve_exact(property_count as usize);
        properties.set_len(property_count as usize);
        self.proc_addr_loader().vkGetPhysicalDeviceDisplayPropertiesKHR(
    ...
    pub unsafe fn get_physical_device_display_plane_properties_khr<Pd>(&self, physical_device: Pd)
        ...
        self.proc_addr_loader().vkGetPhysicalDeviceDisplayPlanePropertiesKHR(
            physical_device.handle().to_raw(), &mut property_count, ptr::null_mut());
        properties.reserve_exact(property_count as usize);
        properties.set_len(property_count as usize);
        self.proc_addr_loader().vkGetPhysicalDeviceDisplayPlanePropertiesKHR(
    ...
    pub unsafe fn get_display_plane_supported_displays_khr<Pd>(&self, physical_device: Pd, plane_index: u32)
        ...
        self.proc_addr_loader().vkGetDisplayPlaneSupportedDisplaysKHR(
    ...
    pub unsafe fn get_display_mode_properties_khr<Pd, D>(&self, physical_device: Pd, display: D)
        ...
        self.proc_addr_loader().vkGetDisplayModePropertiesKHR(
    ...
    pub unsafe fn create_display_mode_khr<Pd, D>(&self, physical_device: Pd, display: D,
        ...
        let allocator = allocator.unwrap_or(ptr::null());
        let mut mode = 0;
        ::check(self.proc_addr_loader().vkCreateDisplayModeKHR(physical_device.handle().to_raw(),
    ...
    pub unsafe fn get_display_plane_capabilities_khr<Pd, M>(&self, physical_device: Pd, mode: M,
        ...
        let mut capabilities = mem::uninitialized();
        ::check(self.proc_addr_loader().vkGetDisplayPlaneCapabilitiesKHR(physical_device.handle().to_raw(),
    ...
    pub unsafe fn create_display_plane_surface_khr(&self, create_info: DisplaySurfaceCreateInfoKhr,
        ...
        let allocator = allocator.unwrap_or(ptr::null());
        let mut surface = 0;
        ::check(self.proc_addr_loader().vkCreateDisplayPlaneSurfaceKHR(self.handle().to_raw(),
    ...
    pub unsafe fn create_xlib_surface_khr(&self, create_info: &XlibSurfaceCreateInfoKhr,
        ...
        let allocator = allocator.unwrap_or(ptr::null());
        let mut surface = 0;
        ::check(self.proc_addr_loader().vkCreateXlibSurfaceKHR(self.handle().to_raw(),
            create_info.as_raw(), allocator, &mut surface));
        Ok(SurfaceKhrHandle(surface))
    }
    ...
    pub unsafe fn get_physical_device_xlib_presentation_support_khr<Pd>(&self, physical_device: Pd,
            ...
            where Pd: Handle<Target=PhysicalDeviceHandle> {
        self.proc_addr_loader().vkGetPhysicalDeviceXlibPresentationSupportKHR(
            physical_device.handle().to_raw(), queue_family_index, dpy, visual_id) != 0
    }
    ...
    pub unsafe fn create_xcb_surface_khr(&self, create_info: &XcbSurfaceCreateInfoKhr,
        ...
        let allocator = allocator.unwrap_or(ptr::null());
        let mut surface = 0;
        ::check(self.proc_addr_loader().vkCreateXcbSurfaceKHR(self.handle().to_raw(),
            create_info.as_raw(), allocator, &mut surface));
        Ok(SurfaceKhrHandle(surface))
    }
    ...
    pub unsafe fn get_physical_device_xcb_presentation_support_khr<Pd>(&self, physical_device: Pd,
        queue_family_index: u32, connection: *mut xcb_connection_t, visual_id: xcb_visualid_t)
             -> bool
            where Pd: Handle<Target=PhysicalDeviceHandle> {
        self.proc_addr_loader().vkGetPhysicalDeviceXcbPresentationSupportKHR(
            physical_device.handle().to_raw(), queue_family_index, connection, visual_id) != 0
    ...
    pub unsafe fn create_mir_surface_khr(&self,
        ...
        let allocator = allocator.unwrap_or(ptr::null());
        let mut surface = 0;
        ::check(self.proc_addr_loader().vkCreateMirSurfaceKHR(self.handle().to_raw(),
            create_info.as_raw(), allocator, &mut surface));
        Ok(SurfaceKhrHandle(surface))
    }
    ...
    pub unsafe fn get_physical_device_mir_presentation_support_khr<Pd>(&self,
            ...
            where Pd: Handle<Target=PhysicalDeviceHandle> {
        self.proc_addr_loader().vkGetPhysicalDeviceMirPresentationSupportKHR(
            physical_device.handle().to_raw(), queue_family_index, connection)  != 0
    }
    ...
    pub unsafe fn create_android_surface_khr(&self, create_info: &AndroidSurfaceCreateInfoKhr,
        ...
        let allocator = allocator.unwrap_or(ptr::null());
        let mut surface = 0;
        ::check(self.proc_addr_loader().vkCreateAndroidSurfaceKHR(self.handle().to_raw(),
            create_info.as_raw(), allocator, &mut surface));
        Ok(SurfaceKhrHandle(surface))
    }
    ...
    pub unsafe fn get_physical_device_win32_presentation_support_khr<Pd>(&self, physical_device: Pd,
            ...
            where Pd: Handle<Target=PhysicalDeviceHandle> {
        self.proc_addr_loader().vkGetPhysicalDeviceWin32PresentationSupportKHR(
            physical_device.handle().to_raw(), queue_family_index) != 0
    }
    ...
    pub unsafe fn get_physical_device_features_2_khr<Pd>(&self, physical_device: Pd)
            -> VooResult<PhysicalDeviceFeatures2Khr>
            where Pd: Handle<Target=PhysicalDeviceHandle> {
        let mut features = mem::uninitialized();
        self.proc_addr_loader().vkGetPhysicalDeviceFeatures2KHR(physical_device.handle().to_raw(),
            &mut features);
        Ok(PhysicalDeviceFeatures2Khr::from_raw(features))
    }
    ...
    pub unsafe fn get_physical_device_properties_2_khr<Pd>(&self, physical_device: Pd)
            -> VooResult<PhysicalDeviceProperties2Khr>
            where Pd: Handle<Target=PhysicalDeviceHandle> {
        ...
        Ok(PhysicalDeviceProperties2Khr::from_raw(properties))
    }
    ...
    pub unsafe fn get_physical_device_format_properties_2_khr<Pd>(&self, physical_device: Pd, format: Format)
            -> VooResult<FormatProperties2Khr>
            where Pd: Handle<Target=PhysicalDeviceHandle> {
        let mut props: FormatProperties2Khr = mem::uninitialized();
        self.proc_addr_loader().vkGetPhysicalDeviceFormatProperties2KHR(physical_device.handle().to_raw(),
    ...
    pub unsafe fn get_physical_device_image_format_properties_2_khr<Pd>(&self, physical_device: Pd,
            ...
            where Pd: Handle<Target=PhysicalDeviceHandle> {
        let mut image_format_properties = mem::uninitialized();
        ::check(self.proc_addr_loader().vkGetPhysicalDeviceImageFormatProperties2KHR(
    ...
    pub unsafe fn get_physical_device_external_buffer_properties_khr<Pd>(&self,
            ...
            -> VooResult<ExternalBufferPropertiesKhr>
            where Pd: Handle<Target=PhysicalDeviceHandle> {
        ...
        Ok(ExternalBufferPropertiesKhr::from_raw(external_buffer_properties))
    }
    ...
    pub unsafe fn get_physical_device_external_semaphore_properties_khr<Pd>(&self,
            ...
            -> VooResult<ExternalSemaphorePropertiesKhr>
            where Pd: Handle<Target=PhysicalDeviceHandle> {
        ...
        Ok(ExternalSemaphorePropertiesKhr::from_raw(external_semaphore_properties))
    }
    ...
    pub unsafe fn get_physical_device_external_fence_properties_khr<Pd>(&self,
            ...
            -> VooResult<ExternalFencePropertiesKhr>
            where Pd: Handle<Target=PhysicalDeviceHandle> {
        ...
        Ok(ExternalFencePropertiesKhr::from_raw(external_fence_properties))
    }
    ...
    pub unsafe fn get_physical_device_surface_capabilities_2_khr<Pd>(&self, physical_device: Pd,
            ...
            where Pd: Handle<Target=PhysicalDeviceHandle> {
        let mut capabilities = mem::uninitialized();
        self.proc_addr_loader().vkGetPhysicalDeviceSurfaceCapabilities2KHR(
    ...
    pub unsafe fn get_physical_device_surface_formats_2_khr<Pd>(&self, physical_device: Pd,
        ...
        self.proc_addr_loader().vkGetPhysicalDeviceSurfaceFormats2KHR(
    ...
    pub unsafe fn create_debug_report_callback_ext(&self,
        ...
        let allocator = allocator.unwrap_or(ptr::null());
        let mut callback = 0;
        ::check(self.proc_addr_loader().vkCreateDebugReportCallbackEXT(self.handle().to_raw(),
    ...
    pub unsafe fn get_physical_device_external_image_format_properties_nv<Pd>(&self,
        ...
        ::check(self.proc_addr_loader().vkGetPhysicalDeviceExternalImageFormatPropertiesNV(
            physical_device.handle().to_raw(), format.into(), type_.into(),
    ...
    pub unsafe fn get_physical_device_present_rectangles_khx<Pd, S>(&self,
        ...
        ::check(self.proc_addr_loader().vkGetPhysicalDevicePresentRectanglesKHX(
    ...
    pub unsafe fn create_vi_surface_nn(&self, create_info: &ViSurfaceCreateInfoNn,
        ...
        let allocator = allocator.unwrap_or(ptr::null());
        let mut surface = 0;
        ::check(self.proc_addr_loader().vkCreateViSurfaceNN(
            self.handle().to_raw(), create_info.as_raw(), allocator, &mut surface));
        Ok(SurfaceKhrHandle(surface))
    }
    ...
    pub unsafe fn release_display_ext<Pd, D>(&self, physical_device: Pd, display: D)
            where Pd: Handle<Target=PhysicalDeviceHandle>, D: Handle<Target=DisplayKhrHandle> {
        ::check(self.proc_addr_loader().vkReleaseDisplayEXT(
    ...
    pub unsafe fn acquire_xlib_display_ext<Pd, D>(&self, physical_device: Pd, dpy: *mut Display, display: D)
            where Pd: Handle<Target=PhysicalDeviceHandle>, D: Handle<Target=DisplayKhrHandle> {
        ::check(self.proc_addr_loader().vkAcquireXlibDisplayEXT(
    ...
    pub unsafe fn get_rand_r_output_display_ext<Pd, D>(&self, physical_device: Pd,
            ...
            where Pd: Handle<Target=PhysicalDeviceHandle>, D: Handle<Target=DisplayKhrHandle> {
        let mut display = 0;
        ::check(self.proc_addr_loader().vkGetRandROutputDisplayEXT(physical_device.handle().to_raw(),
    ...
    pub unsafe fn get_physical_device_surface_capabilities_2_ext<Pd, S>(&self, physical_device: Pd,
        ...
        ::check(self.proc_addr_loader().vkGetPhysicalDeviceSurfaceCapabilities2EXT(
    ...
    pub unsafe fn create_ios_surface_mvk(&self, create_info: &IosSurfaceCreateInfoMvk,
        ...
        let allocator = allocator.unwrap_or(ptr::null());
        let mut surface = 0;
        ::check(self.proc_addr_loader().vkCreateIOSSurfaceMVK(
            self.handle().to_raw(), create_info.as_raw(), allocator, &mut surface));
        Ok(SurfaceKhrHandle(surface))
    }
    ...
    pub unsafe fn create_mac_os_surface_mvk(&self, create_info: &MacOsSurfaceCreateInfoMvk,
        ...
        let allocator = allocator.unwrap_or(ptr::null());
        let mut surface = 0;
        ::check(self.proc_addr_loader().vkCreateMacOSSurfaceMVK(
            self.handle().to_raw(), create_info.as_raw(), allocator, &mut surface));
        Ok(SurfaceKhrHandle(surface))
    }
    ...
    pub unsafe fn get_physical_device_multisample_properties_ext<Pd>(&self, physical_device: Pd,
        ...
        ::check(self.proc_addr_loader().vkGetPhysicalDeviceMultisamplePropertiesEXT(
